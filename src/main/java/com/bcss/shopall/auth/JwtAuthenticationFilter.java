...
import com.bcss.shopall.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService jwtService, UserDetailsService userDetailsService, TokenRepository tokenRepository, PersonaService personaService) {
    ...
    protected void doFilterInternal(
        ...
        if (isTokenExpiredOrRevoked) {
            final Optional<Persona> user = personaService.findByEmail(userEmail);
