package com.bcss.shopall.config;

import com.bcss.shopall.auth.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, AuthenticationProvider authenticationProvider, TokenRepository tokenRepository) {
